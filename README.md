...
|-----|------------------------------------------------|:--------:|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| R01 | All countries in the world                     | ✅ Yes   | [R01_world.csv](docs/evidence/R01_world.csv) · <img src="docs/evidence/R01_world.png" alt="R01 screenshot" width="220" />                                                       |
...
| R04 | Top-N countries in the world                   | ✅ Yes   | [R04_world_top5.csv](docs/evidence/R04_world_top5.csv) · <img src="docs/evidence/R04_world_top5.png" alt="R04 screenshot" width="220" />                                        |

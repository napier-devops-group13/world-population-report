 ...
 * verify the CSV responses are ordered by population DESC, and
 * that validation/CSV escaping branches are exercised.
 */
class CountryRoutesTest {
     ...
     * so we can cover all its branches (null/plain/quoted).
     */
    ...
    // ------------------------------------------------------------------
    // Validation tests – world top (n must be positive integer)
    // ------------------------------------------------------------------
    ...
    // ------------------------------------------------------------------
    // Validation tests – continent/region top
    //   (exercise the same check(...) branches in those handlers)
    // ------------------------------------------------------------------
    ...
    // ------------------------------------------------------------------
    // Direct tests for private escape(..) to hit all its branches
    // ------------------------------------------------------------------
